...
* Instagram feed - e.g. showcase your Instagram photos & videos
...
* [Demo 4](http://wpsofts.com/grid-kit-demo/instagram/) » Instagram Feed
* [Demo 5](http://wpsofts.com/grid-kit-demo/slider/) » Photo gallery slider
* [Demo 6](https://wpsofts.com/grid-kit-demo/carousel/) » Photo gallery carousel
...
* WP 6.6.1 compatibility note added

= 2.2.0 =
* Spinner related issue was resolved for WordPress v6.2.2

= 2.1.1 =
* Layout delete function resolved
...
= 2.0.0 =
* CSRF / XSS vulnerability issues were resolved

= 1.8.24 =
* W3C CSS error resolved
